...
equation
  ...
  connect(onDelay2.y, sequencer.stepsFeedback[2]) annotation (
    Line(points = {{128, 0}, {146, 0}, {146, -80}, {-54, -80}, {-54, 0}, {-44, 0}}, color = {255, 0, 255}));
  connect(srff2.Q1, onDelay2.u) annotation (
    Line(points = {{86.2, 6}, {100.2, 6}, {100.2, 1.78814e-07}, {101.2, 1.78814e-07}, {101.2, 1.78814e-07}, {102.2, 1.78814e-07}}, color = {255, 0, 255}));
